require.register("templates/teachers/restricted-to-teachers-view", function(exports, require, module) {
...
buf.push("</div><div class=\"container\"><div class=\"teacher-account-blurb text-center col-xs-6 col-xs-offset-3 m-y-3\"><h5 data-i18n=\"teacher.what_is_a_teacher_account\"></h5><p data-i18n=\"teacher.teacher_account_explanation\"></p></div></div></div><div class=\"container-fluid\"><div id=\"footer\" class=\"small\"><div class=\"container\"><div class=\"row\"><div class=\"col-sm-3\"><ul class=\"list-unstyled\"><li><strong>CodeCombat</strong></li><li><a href=\"/about\" data-i18n=\"nav.about\"></a></li><li><a href=\"/about#jobs\" data-i18n=\"nav.jobs\"></a></li><li><a href=\"http://blog.codecombat.com/\" data-i18n=\"nav.blog\"></a></li><li><a href=\"/legal\" data-i18n=\"nav.legal\"></a></li><li><a href=\"/privacy\" data-i18n=\"nav.privacy\"></a></li></ul></div>");
if ( !me.isStudent())
{
...
;require.register("views/teachers/RestrictedToTeachersView", function(exports, require, module) {
var RestrictedToTeachersView, RootView,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

RootView = require('views/core/RootView');

module.exports = RestrictedToTeachersView = (function(superClass) {
  extend(RestrictedToTeachersView, superClass);

  function RestrictedToTeachersView() {
    return RestrictedToTeachersView.__super__.constructor.apply(this, arguments);
  }

  RestrictedToTeachersView.prototype.id = 'restricted-to-teachers-view';

  RestrictedToTeachersView.prototype.template = require('templates/teachers/restricted-to-teachers-view');

  RestrictedToTeachersView.prototype.initialize = function() {
    var ref;
    return (ref = window.tracker) != null ? ref.trackEvent('Restricted To Teachers Loaded', {
      category: 'Students'
    }, ['Mixpanel']) : void 0;
  };
...
;
//# sourceMappingURL=/javascripts/app/views/teachers/RestrictedToTeachersView.js.map