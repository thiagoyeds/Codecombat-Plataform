require.register("templates/clans/clans", function(exports, require, module) {
...
{
buf.push("<a" + (jade.attrs({ 'href':("/clans/" + (clan.id) + ""), 'style':('font-weight:bold') }, {"href":true,"style":true})) + ">" + (jade.escape(null == (jade.interp = clan.get('name')) ? "" : jade.interp)) + "</a>");
}
else
{
buf.push("<a" + (jade.attrs({ 'href':("/clans/" + (clan.id) + "") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = clan.get('name')) ? "" : jade.interp)) + "</a>");
}
buf.push("</td><td>" + (jade.escape(null == (jade.interp = clan.get('memberCount')) ? "" : jade.interp)) + "</td><td> ");
...
{
buf.push("<button" + (jade.attrs({ 'data-id':("" + (clan.id) + ""), 'data-i18n':("clans.join_clan"), "class": [('btn'),('btn-success'),('join-clan-btn')] }, {"data-id":true,"data-i18n":true})) + ">Join Clan</button>");
}
else if ( clan.get('ownerID') !== me.id)
{
buf.push("<button" + (jade.attrs({ 'data-id':("" + (clan.id) + ""), 'data-i18n':("clans.leave_clan"), "class": [('btn'),('btn-xs'),('btn-warning'),('leave-clan-btn')] }, {"data-id":true,"data-i18n":true})) + ">Leave Clan</button>");
}
buf.push("</td></tr>");
    }
...
buf.push("</tbody></table></div><div id=\"my-clans\" role=\"tabpanel\" class=\"tab-pane\"><table class=\"table table-striped table-condensed\"><thead><tr><th data-i18n=\"clans.clan_name\">Clan Name</th><th data-i18n=\"play.heroes\">Heroes</th><th data-i18n=\"clans.chieftain\">Chieftain</th><th data-i18n=\"editor.level_components_type\">Type</th><th></th></tr></thead><tbody>");
if ( view.myClansArray.length)
{
// iterate view.myClansArray
;(function(){
  var $$obj = view.myClansArray;
  if ('number' == typeof $$obj.length) {
...
buf.push("</td><td>" + (jade.escape(null == (jade.interp = clan.get('type')) ? "" : jade.interp)) + "</td><td>");
if ( clan.get('ownerID') !== me.id)
{
buf.push("<button" + (jade.attrs({ 'data-id':("" + (clan.id) + ""), 'data-i18n':("clans.leave_clan"), "class": [('btn'),('btn-xs'),('btn-warning'),('leave-clan-btn')] }, {"data-id":true,"data-i18n":true})) + ">Leave Clan</button>");
}
...
buf.push("</tbody></table></div></div></div><div class=\"achievement-corner\"></div><div id=\"site-footer\"><img id=\"footer-background\" src=\"/images/pages/base/nav_background.png\"/><div" + (jade.attrs({ 'id':('footer-links'), "class": [(features.playViewsOnly ? 'hide' : '')] }, {"class":true})) + "><a href=\"/about\" data-i18n=\"nav.about\"></a>");
if ( !me.isStudent())
{
...
;
//# sourceMappingURL=/javascripts/app/templates/clans/clans.js.map