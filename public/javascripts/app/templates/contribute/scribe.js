require.register("templates/contribute/scribe", function(exports, require, module) {
...
buf.push("<select class=\"language-dropdown form-control\"></select></div></div><div id=\"site-content-area\"><div class=\"contribute_class\"><div class=\"class_detail\"><img src=\"/images/pages/contribute/class_detail_scribe.png\" alt=\"\"/></div><div id=\"scribe-main\" class=\"class-main\"><h2><span data-i18n=\"classes.scribe_title\">Scribe</span><span> </span><span data-i18n=\"classes.scribe_title_description\">(Article Editor)</span></h2><p><span data-i18n=\"contribute.scribe_introduction_pref\">CodeCombat isn't just going to be a bunch of levels.\nIt will also include a resource for knowledge, a wiki of programming concepts that levels can hook into.\nThat way rather than each Artisan having to describe in detail what a comparison operator is, they\ncan simply link their level to the Article describing them that is already written for the player's edification.\nSomething along the lines of what the </span><a href=\"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide\" data-i18n=\"contribute.scribe_introduction_url_mozilla\">Mozilla Developer Network </a><span data-i18n=\"contribute.scribe_introduction_suf\"> \nhas built. If your idea of fun is articulating the concepts of programming in Markdown form,\nthen this class might be for you.</span></p><h4 data-i18n=\"contribute.class_attributes\">Class Attributes</h4><ul><li data-i18n=\"contribute.scribe_attribute_1\">Skill in words is pretty much all you need.\nNot only grammar and spelling, but able to convey complicated ideas to others.</li></ul><h4 data-i18n=\"contribute.how_to_join\">How To Join</h4><p><a tabindex=\"-1\" data-toggle=\"coco-modal\" data-target=\"core/ContactModal\" data-i18n=\"contribute.contact_us_url\">Contact us</a><span>, </span><span data-i18n=\"contribute.scribe_join_description\">tell us a little about yourself, your experience with programming and\nwhat sort of things you'd like to write about. We'll go from there!</span></p><div class=\"contributor-signup-anonymous\"></div><div data-contributor-class-id=\"article_editor\" data-contributor-class-name=\"scribe\" class=\"contributor-signup\"></div><h3 data-i18n=\"contribute.diligent_scribes\">Our Diligent Scribes:</h3><div id=\"contributor-list\" data-contributor-class-name=\"scribe\"></div></div><div class=\"clearfix\"></div></div></div><div class=\"achievement-corner\"></div><div id=\"site-footer\"><img id=\"footer-background\" src=\"/images/pages/base/nav_background.png\"/><div" + (jade.attrs({ 'id':('footer-links'), "class": [(features.playViewsOnly ? 'hide' : '')] }, {"class":true})) + "><a href=\"/about\" data-i18n=\"nav.about\"></a>");
if ( !me.isStudent())
{
...
;
//# sourceMappingURL=/javascripts/app/templates/contribute/scribe.js.map