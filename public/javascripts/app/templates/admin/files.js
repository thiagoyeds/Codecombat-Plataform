require.register("templates/admin/files", function(exports, require, module) {
...
buf.push("<select class=\"language-dropdown form-control\"></select></div></div><div id=\"site-content-area\"><h1>Files</h1><select id=\"folder-select\"><option value=\"music\">Music</option><option value=\"interface\">Interface</option></select><a id=\"upload-button\" class=\"btn\"><i class=\"icon-upload\"></i></a><table id=\"file-table\"></table></div><div class=\"achievement-corner\"></div><div id=\"site-footer\"><img id=\"footer-background\" src=\"/images/pages/base/nav_background.png\"/><div" + (jade.attrs({ 'id':('footer-links'), "class": [(features.playViewsOnly ? 'hide' : '')] }, {"class":true})) + "><a href=\"/about\" data-i18n=\"nav.about\"></a>");
if ( !me.isStudent())
{
...
;
//# sourceMappingURL=/javascripts/app/templates/admin/files.js.map