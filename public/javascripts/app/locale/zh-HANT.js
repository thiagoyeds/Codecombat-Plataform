require.register("locale/zh-HANT", function(exports, require, module) {
module.exports = {
  ...
  translation: {
    ...
    share_progress_modal: {
      blurb: "您正在創造偉大的旅程！告訴您的家長，您從CodeCombat學到了什麼！",
    ...
    subscribe: {
      ...
      feature1: "__levelsCount__ 個以上的基本關卡分佈在__worldsCount__張地圖中",
      feature2: "__heroesCount__ 個強力的<strong>新英雄</strong>並且每位都有不同技能！",
      feature3: "__bonusLevelsCount__ 個以上的額外關卡",
      ...
      stripe_description_year_sale: "年費訂閱 (${{discount}} 優惠)",
    ...
    about: {
      ...
      community_description_1: "CodeCombat 是一個社群專案，由有數以百計的玩家志願來建立遊戲關卡，建構我們的程式碼來添加功能、修正 Bugs、執行測試、甚至翻譯此遊戲至超過 50 種語言。如同多數的開源社群一般，所有的員工、貢獻者們及 CodeCombat 都獲益於持續的互相分享靈感和彙整努力。CodeCombat 是建立於無數的開源專案之上，因此我們開源回饋給社群朋友，提供一個友善專案給對於原始碼有興趣的玩家來探索和實驗。任何人都可以加入 CodeCombat 社群！請查看我們的",
...
;
//# sourceMappingURL=/javascripts/app/locale/zh-HANT.js.map