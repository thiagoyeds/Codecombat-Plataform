require.register("locale/ru", function(exports, require, module) {
module.exports = {
  ...
  translation: {
    ...
    play: {
      ...
      play_classroom_version: "Играть в версию для класса",
    ...
    play_level: {
      ...
      tome_reload_method: "Загрузить оригинальный код и начать уровень заново",
    ...
    subscribe: {
      ...
      comparison_blurb: "Отточите свое мастерство с подпиской на CodeCombat!",
      premium_pricing_prefix: "Получите Премиум всего лишь за",
      premium_pricing_suffix: "и станьте мастером кода.",
      premium: "Премиум",
      feature1: "__levelsCount__+ основных уровней для изучения Python, JavaScript, Lua или CoffeeScript",
      feature2: "__heroesCount__ могущественных <strong>новых героев</strong> с уникальными способностями!",
      feature3: "__bonusLevelsCount__+ дополнительных уровней",
      ...
      payment_methods_blurb1: "На данный момент мы принимаем кредитные карты и Alipay. Также вы можете отправить ${{three_month_price}} через PayPal в адрес nick@codecombat.com с указанием своего e-mail, чтобы получить подписку на 3 месяца. Либо отправьте ${{year_price}} для подписки на год.",
      payment_methods_blurb2: "Если вам необходим альтернативный способ оплаты, пожалуйста, свяжитесь",
      sale_button: "Распродажа!",
      sale_button_title: "Сэкономьте ${{discount}} при приобретении годовой подписки",
      stripe_description: "Месячная подписка",
      stripe_description_year_sale: "Годовая подписка (${{discount}} скидка)",
    ...
    account_settings: {
      ...
      type_in_email: "Введите ваш e-mail для подтверждения удаления аккаунта",
    ...
    courses: {
      ...
      send_invites: "Пригласить учеников",
      ...
      option1_header: "Вариант 1: Пригласить учеников по e-mail",
      ...
      click_to_start: "Нажмите здесь, чтобы начать",
      my_courses: "Мои курсы",
      classroom: "Класс",
...
;
//# sourceMappingURL=/javascripts/app/locale/ru.js.map