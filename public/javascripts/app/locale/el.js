require.register("locale/el", function(exports, require, module) {
module.exports = {
  ...
  translation: {
    ...
    play: {
      ...
      owned: "Σου ανήκει",
      locked: "Κλειδωμένο",
      purchasable: "Διαθέσιμο για αγορά",
      available: "Διαθέσιμο",
      ...
      play_classroom_version: "Παίξε σε Μορφή Μαθημάτων",
    ...
    play_level: {
      ...
      tome_reload_method: "Φόρτωσε ξανά τον αρχικό κώδικα για τη μέθοδο αυτή",
    ...
    subscribe: {
      ...
      feature1: "__levelsCount__+ βασικά επίπεδα που εκτείνονται σε __worldsCount__ κόσμους",
      feature2: "__heroesCount__ παντοδύναμοι <strong>νέοι ήρωες</strong> με μοναδικές ικανότητες!",
      feature3: "__bonusLevelsCount__+ επίπεδα δώρο",
      ...
      sale_button_title: "Γλίτωσε ${{discount}} όταν αγοράσεις συνδρομή ετήσια συνδρομή",
      stripe_description: "Μηνιαία Συνδρομή",
      stripe_description_year_sale: "Ετήσια Συνδρομή (${{discount}} έκπτωση)",
    ...
    ladder: {
      ...
      winners: "Νικητές",
      league: "Πρωτάθλημα",
      red_ai: "Η ΤΝ (Τεχνητή Νοημοσύνη) των κόκκινων",
    ...
    loading_error: {
      ...
      timeout: "Ο Εξυπηρετητής Δεν Απάντησε",
...
;
//# sourceMappingURL=/javascripts/app/locale/el.js.map