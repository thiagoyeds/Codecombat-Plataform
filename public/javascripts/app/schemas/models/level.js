...
var EventPrereqSchema, GeneralArticleSchema, GoalSchema, LevelSchema, LevelSystemSchema, LevelThangSchema, NoteGroupSchema, PointSchema, ResponseSchema, ScriptSchema, SpecificArticleSchema, SpriteCommandSchema, ThangComponentSchema, c, eventPrereqValueTypes, side, thang;
...
_.extend(LevelSchema.properties, {
  ...
  type: c.shortString({
    title: 'Type',
    description: 'What type of level this is.',
    'enum': ['campaign', 'ladder', 'ladder-tutorial', 'hero', 'hero-ladder', 'hero-coop', 'course', 'course-ladder', 'game-dev', 'web-dev']
  }),
  kind: c.shortString({
    title: 'Kind',
    description: 'Similar to type, but just for our organization.',
    "enum": ['demo', 'usage', 'mastery', 'advanced', 'practice', 'challenge']
  }),
  ...
  shareable: {
    ...
    description: 'Whether the level is not shareable (false), shareable (true), or a sharing-encouraged project level ("project"). Make sure to use "project" for project levels so they show up correctly in the Teacher Dashboard.'
  },
  adventurer: {
    type: 'boolean'
  },
  ...
  requiredProperties: {
    ...
    description: 'Names of properties a hero must have equipped to play.',
    format: 'solution-gear',
  ...
  restrictedProperties: {
    ...
    description: 'Names of properties a hero must not have equipped to play.',
  ...
  recommendedHealth: {
    ...
    minimum: 0,
    exclusiveMinimum: true,
    description: 'If set, will show the recommended health to be able to beat this level with the intended main solution to the player when choosing equipment.',
    format: 'solution-stats',
  ...
  primaryConcepts: c.array({
    title: 'Primary Concepts',
    description: 'The main 1-3 concepts this level focuses on.',
    uniqueItems: true
  }, c.concept),
  picoCTFProblem: {
    type: 'string',
...
;
//# sourceMappingURL=/javascripts/app/schemas/models/level.js.map