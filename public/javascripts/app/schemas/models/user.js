...
_.extend(UserSchema.properties, {
  ...
  coursePrepaid: {
    ...
    properties: {
      ...
      includedCourseIDs: {
        type: ['array', 'null'],
        description: 'courseIDs that this prepaid includes access to',
        items: c.objectId()
      }
    }
  },
  ...
  role: {
    type: 'string',
    "enum": ["advisor", "parent", "principal", "student", "superintendent", "teacher", "technology coordinator"]
  },
...
;
//# sourceMappingURL=/javascripts/app/schemas/models/user.js.map