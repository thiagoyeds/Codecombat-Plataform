...
_.extend(ThangTypeSchema.properties, {
  ...
  restricted: {
    type: 'string',
    title: 'Restricted',
    description: 'If set, this ThangType will only be accessible by admins and whoever it is restricted to.'
  }
});
...
;
//# sourceMappingURL=/javascripts/app/schemas/models/thang_type.js.map