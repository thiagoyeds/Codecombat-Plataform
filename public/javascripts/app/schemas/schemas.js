...
var ColorConfigSchema, Language, PointSchema, SoundSchema, basicProps, combine, concept, concepts, me, namedProps, patchableProps, pathPattern, permissionsProps, searchableProps, urlPattern, versionedProps;
...
me.concept = {
  ...
  "enum": (function() {
    var i, len, results;
    results = [];
    for (i = 0, len = concepts.length; i < len; i++) {
      concept = concepts[i];
      results.push(concept.concept);
    }
    return results;
  })(),
  format: 'concept'
...
;
//# sourceMappingURL=/javascripts/app/schemas/schemas.js.map